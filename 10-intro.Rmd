...
- *Right*: the right to run an agreed-upon computation, issue by a data
...
Na\"ively, a DRT is merely the digital representation of an
instance of a right issued by some data provider to any data consumer.  It is
the purpose of this document formalize certain aspects, while leaving certain
aspects up to implementors.
